 ...
 */
package org.onnx4j.opsets.aiOnnx.v4;
 ...
 *
 */
public interface AiOnnxOperatorSetSpecV4<T_TENSOR> extends AiOnnxOperatorSetSpecV3<T_TENSOR> {
	
	public abstract ConcatV4<T_TENSOR> getConcatV4();

	//@Override
	public default Map<String, Operator> initializeOperators() {
		Map<String, Operator> operators = AiOnnxOperatorSetSpecV3.super.initializeOperators();
		// 20191119
