 ...
 * @see <a href=
 *      "https://github.com/onnx/onnx/blob/master/docs/Changelog.md#Softmax-11">ONNX.
 *      Changelog.md</a>
 * @see <a href=
 *      "https://github.com/onnx/onnx/blob/master/docs/Operators.md#Softmax">ONNX.
 *      Operators.md</a>
 */
public interface SoftmaxV11<T_TENSOR> extends SoftmaxV1<T_TENSOR>, AiOnnxOperatorV11 {

	class SoftmaxInputV11<T_TENSOR> extends SoftmaxInputV1<T_TENSOR> {

		public SoftmaxInputV11(Node node, Inputs inputs) {
			super(node, inputs);
		}
	...
	public default Outputs forward(Node node, Inputs inputs) {
		SoftmaxInputV11<T_TENSOR> operatorInput = new SoftmaxInputV11<T_TENSOR>(node, inputs);
